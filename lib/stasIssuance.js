...
async function signedFunc(issuerPrivateKey, issueData, contractUtxo, paymentUtxo, paymentPrivateKey, isSplittable, symbol, protocol, isZeroChange = false, txCost, feeEstimateCall) {
  ...
  return unSignedFunc(issuerPrivateKey.publicKey.toString('hex'), contractUtxo, paymentPubKey, paymentUtxo, issueData, isSplittable, symbol, protocol, isZeroChange, issuerPrivateKey, paymentPrivateKey, txCost, feeEstimateCall);
}
