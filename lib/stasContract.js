...
async function signedFunc(issuerPrivateKey, contractUtxo, paymentUtxo, paymentPrivateKey, tokenSchema, tokenSatoshis, isZeroChange = false, txCost, feeEstimateCall) {
  ...
  return await unSignedFunc(issuerPrivateKey.publicKey.toString('hex'), contractUtxo, paymentPubKey, paymentUtxo, tokenSchema, tokenSatoshis, isZeroChange, issuerPrivateKey, paymentPrivateKey, txCost, feeEstimateCall);
}
