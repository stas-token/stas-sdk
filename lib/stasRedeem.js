...
function signedFunc(ownerPrivateKey, stasUtxo, paymentUtxo, paymentPrivateKey, data, isZeroChange, txCost, feeEstimateCall ) {
  ...
  return unSignedFunc(ownerPrivateKey.publicKey.toString('hex'), stasUtxo, paymentPubKey, paymentUtxo, data, isZeroChange, ownerPrivateKey, paymentPrivateKey, txCost, feeEstimateCall);
}
