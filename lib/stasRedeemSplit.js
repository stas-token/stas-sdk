...
async function signedFunc(ownerPrivateKey, stasUtxo, splitDestinations, paymentUtxo, paymentPrivateKey, data, isZeroChange, txCost, feeEstimateCall) {
  ...
  return await unSignedFunc(ownerPrivateKey.publicKey.toString('hex'), stasUtxo, paymentPubKey, paymentUtxo, splitDestinations, data, isZeroChange, ownerPrivateKey, paymentPrivateKey, txCost, feeEstimateCall);
}
