...
async function signedFunc(ownerPrivatekey, stasUtxo, destinationAddress, paymentUtxo, paymentPrivateKey, data, isZeroChange, txCost, feeEstimateCall) {
  ...
  return await unSignedFunc(ownerPrivatekey.publicKey.toString('hex'), stasUtxo, destinationAddress, paymentUtxo, paymentPubKey, data, isZeroChange, ownerPrivatekey, paymentPrivateKey, txCost, feeEstimateCall);
}
