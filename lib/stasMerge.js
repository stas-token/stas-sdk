...
async function signedFunc(ownerPrivateKey1, stasInput1, ownerPrivateKey2, stasInput2, destinationAddr, paymentPrivateKey, paymentUtxo, data, isZeroChange, txCost, feeEstimateCall) {
  ...
  return await unSignedFunc(ownerPrivateKey1.publicKey.toString('hex'), stasInput1, ownerPrivateKey2.publicKey.toString('hex'), stasInput2, destinationAddr, paymentPubKey, paymentUtxo, data, isZeroChange, ownerPrivateKey1, ownerPrivateKey2, paymentPrivateKey, txCost, feeEstimateCall);
}
